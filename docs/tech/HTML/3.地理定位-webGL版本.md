...
<head>
	...
	<script type="text/javascript" src="//api.map.baidu.com/api?type=webgl&v=1.0&ak=NmvHDwHjYbFzPiC8uUiUiHTRcR3XnQaz"></script>
	<title>视角动画</title>
</head>
<body>
	<div id="allmap"></div>
...
<head>
    ...
    <script type="text/javascript"
        src="//api.map.baidu.com/api?type=webgl&v=1.0&ak=NmvHDwHjYbFzPiC8uUiUiHTRcR3XnQaz"></script>
    <title>视角动画</title>
</head>
